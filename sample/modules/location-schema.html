<div class="location contact" itemscope itemtype="http://schema.org/Organization">
    ...
    <div class="contact">
        <p class="address" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
            <span itemprop="streetAddress">1234 Street Address</span>, <span itemprop="addressLocality">City</span>, <span itemprop="addressRegion">State</span>, <span itemprop="postalCode">95610</span>
        </p>
        ...
        <a href="" class="btn">View More Contacts</a>
    </div>
</div>